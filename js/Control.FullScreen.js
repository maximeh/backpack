L.Control.FullScreen = L.Control.extend({
  ...
  onAdd: function(map) {
    ...
    const containerClass = 'leaflet-control-zoom'; let className; let container;
  ...
  _createButton: function(title, className, container, fn, context) {
    ...
    const fsEventName = fullScreenApi.fullScreenEventName;
    L.DomEvent
        .addListener(container, fsEventName, L.DomEvent.stopPropagation)
        .addListener(container, fsEventName, L.DomEvent.preventDefault)
        .addListener(container, fsEventName, this._handleEscKey, context);

    L.DomEvent
        .addListener(document, fsEventName, L.DomEvent.stopPropagation)
        .addListener(document, fsEventName, L.DomEvent.preventDefault)
        .addListener(document, fsEventName, this._handleEscKey, context);
